...
class StudentControllerTest {
    ...
    void 受講生詳細の例外APIが実行できてステータスが400で返ってくること() throws Exception {
        mockMvc.perform(get("/exception"))
                ...
                .andExpect(content().string("このAPIは現在利用できません。　古いＵＲＬとなっています。"));//エラー
    }
    ...
    void 受講生詳細の更新が実行できて空で返ってくること()
        ...
        mockMvc.perform(put("updateStudent").contentType(MediaType.APPLICATION_JSON).content( //エラー
                        """
                            {
                                "student": {
                                            "id": "1",
   ...
   @Test
    void 受講生詳細の受験生でIDに数字以外を用いた時に入力チェックに掛かること(){
       ...
       assertThat(violations.size()).isEqualTo(1); //エラー
